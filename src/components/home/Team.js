...
const Team = () => {
  ...
  return (
    <div className="h-full">
      ...
      <div className="relative max-h-[80%] overflow-x-auto p-3 text-[1rem]  rounded-lg shadow-[5px_5px_7px_rgba(0,0,0,0.2),-5px_-5px_9px_rgba(255,255,255,10)] dark:shadow-[10px_10px_20px_rgba(43,43,43),-5px_-5px_9px_rgba(59,59,59)]">
